      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p>
              &copy; 2025, Zerodha Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Products</a>
            <br />
          ...
          <div className="col">
            <p>Support</p>
            <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Contact</a>
            <br />
